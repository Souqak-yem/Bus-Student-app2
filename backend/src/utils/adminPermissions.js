export const ADMIN_PAGE_CATALOG = [
  ...
  { key: 'passwordResetRequests', label: 'طلبات استعادة كلمة المرور', path: '/admin/manage/password-reset-requests' },
...
const PATH_TO_KEY = {
  ...
  '/admin/manage/password-reset-requests': 'passwordResetRequests',
...
export function getAdminPageLabel(pageKey) {
  const match = ADMIN_PAGE_CATALOG.find(page => page.key === pageKey)
